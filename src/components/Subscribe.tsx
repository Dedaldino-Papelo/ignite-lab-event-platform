  ...
  return (
    ...
    <div className="min-h-screen bg-blur bg-cover bg-no-repeat flex flex-col items-center">
      <div className="w-full max-w-[1100px] flex items-center justify-between mt-20 mx-auto">
        ...
        <div className="bg-gray-700 p-8 rounded border-gray-500">
          ...
          <form className="flex flex-col gap-2 w-full" onSubmit={HandleSubmit}>
            ...
            <button
              disabled={loading}
              className="mt-4 uppercase bg-green-500 py-4 text-sm rounded disabled:opacity-50 font-bold hover:bg-green-700 transition-colors">
              Garantir minha vaga
            </button>
          </form>
        </div>
